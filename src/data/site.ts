  ...
  representatives: [
    {
      ...
      id: "#rep-sakai",
      bio: "iLe の独自ブリーチ技術「エフェクトブリーチ」を西村 涼とともに開発した共同開発者。ケミカル（薬剤設計）に精通し、ダメージ履歴を10段階で診断して過酸化水素の濃度をミリ単位で調整する「パーソナル減力」を体系化した。複雑な履歴を持つ髪のブリーチ設計を専門とし、美容師向けのカラーセミナーにも多数登壇している。",
      knowsAbout: [
        "エフェクトブリーチ",
        "ブリーチ",
        "ヘアカラーの薬剤設計（ケミカル）",
